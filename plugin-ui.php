			...
			<fieldset><legend><span>Service</span></legend>
				<div class="inside">
					...
					<div class="field">
						...
						<em class="description"><?php _e('Notification text to append to form confirmation (i.e. what\'s shown on-screen).  This message may contain a placeholder for the autogenerated safe message (<code>%2$s</code>) and/or the original plugin message (<code>%1$s</code>)', $P);?>.  <?php _e('Leave blank to ignore', $P);?>.</em>
