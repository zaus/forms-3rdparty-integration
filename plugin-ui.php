			...
			<fieldset><legend><span>Service</span></legend>
				<div class="inside">
					...
					<div class="field">
						...
						<input id="failure-<?php echo $eid?>" type="text" class="text" name="<?php echo $P?>[<?php echo $eid?>][failure]" value="<?php echo esc_attr($entity['failure'])?>" />
						<em class="description"><?php _e('Notification text to append to form confirmation (i.e. what\'s shown on-screen).  This message may contain a placeholder (<code>%s</code>) for the autogenerated safe message', $P);?>.  <?php _e('Leave blank to ignore', $P);?>.</em>
					</div>
					<div class="field">
